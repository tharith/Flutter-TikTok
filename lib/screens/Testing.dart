...
class CardHiddenAnimationPage extends StatefulWidget {
  ...
  @override
  State<CardHiddenAnimationPage> createState() => _CardHiddenAnimationPageState();
}

class _CardHiddenAnimationPageState extends State<CardHiddenAnimationPage> with TickerProviderStateMixin {
    ...
    return Material(
      ...
      child: SizedBox.square(
        ...
        child: DecoratedBox(
          ...
          child: const Center(
            child: Image(image: AssetImage("images/thavrith.jpg"), fit: BoxFit.contain, width: 135,)
          ),
        ),
      ),
    );
